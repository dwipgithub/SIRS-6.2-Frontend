...
const RL37 = () => {
        ...
        try {
            ...
            const rlTemplate = detailkegiatan.data.data.map((value, index) => {
              return {
                ...
                subGroupNama: value.jenis_kegiatan_rl_tiga_titik_tujuh.group_jenis_kegiatan_rl_tiga_titik_tujuh.nama,
            ...
            subGroups.reduce(function (res, value) {
              ...
              res[value.groupId].groupRmFaskesLainnya += value.subGroupRmFaskesLainnya;
    ...
    const hapusData = async(id) => {
        ...
        try {
            await axiosJWT.delete(`/apisirs6v2/rltigatitiktujuh/${id}`,
                customConfig)
            setDataRL((current) =>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div style={{marginBottom: "10px"}}>
                            {
                                user.jenisUserId === 4 ? (
                                        <Link className='btn' to={`/rl37/tambah/`} style={{ marginRight: "5px", fontSize: "18px", backgroundColor: "#779D9E", color: "#FFFFFF" }}>
                                            +
                                        </Link>
