...
export const FormUbahRL34 = () => {
    ...
    const updateDataRLTigaTitikEmpat = async (e) => {
        ...
        try {
            ...
            await axiosJWT.patch('/apisirs6v2/rltigatitikempatdetail/' + id, {
                jumlah,
            }, customConfig);
            setSpinner(false)
    ...
    const getRLTigaTitikEmpatById = async () => {
        setSpinner(true)
        const response = await axiosJWT.get('/apisirs6v2/rltigatitikempatdetail/'+ id, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
            ...
            <form onSubmit={updateDataRLTigaTitikEmpat}>
                ...
                <div className="row mt-3 mb-3">
                    <div className="col-md-12">
                        ...
                        <Link to={`/rl34/`} className='btn btn-info' style={{fontSize:"18px", backgroundColor: "#779D9E", color: "#FFFFFF"}}>
                        ...
                        <table className={style.rlTable}>
                            ...
                            <tbody>
                                <tr key={id}>
                                    ...
                                    <td>
                                        <input type="text" name="jenisPengunjung" className="form-control" value={nama} disabled={true} />
                                    </td>
                                    <td>
