...
const RL34 = () => {
    ...
    const getRL = async (e) => {
        ...
        try {
            ...
            const results = await axiosJWT.get('/apisirs6v2/rltigatitikempat',
                customConfig)
    ...
    const hapusData = async(id) => {
        ...
        try {
            await axiosJWT.delete(`/apisirs6v2/rltigatitikempat/${id}`,
                customConfig)
            setDataRL((current) =>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div style={{marginBottom: "10px"}}>
                            {
                                user.jenisUserId === 4 ? (
                                        <Link className='btn' to={`/rl34/tambah/`} style={{ marginRight: "5px", fontSize: "18px", backgroundColor: "#779D9E", color: "#FFFFFF" }}>
                                            +
                                        </Link>
                                ...
                                {dataRL.map((value, index) => {
                                    ...
                                    return (
                                        <tr key={value.id}>
                                            ...
                                            <td>
                                                <input type="text" name="jenisPengunjung" className="form-control" value={value.jenis_pengunjung_rl_tiga_titik_tempat.nama} disabled={true} />
                                            </td>
                                            <td>
